            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-6 mb-3 roleselect">
                            <label for="rolemodal">Роль</label>
                            <select id="rolemodal" class="custom-select">
                                <?php
                                foreach ($systemrole AS $role) {
                                    echo '<option id="' . $role['name'] . 'option" value="' . $role['id'] . '" >' . $role['name'] . '</option>';
                                }
                                ?>
                            </select>
                        </div>
